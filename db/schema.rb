...
ActiveRecord::Schema.define(version: 20200210183154) do
  ...
  create_table "services", force: :cascade do |t|
    ...
    t.index ["public"], name: "index_services_on_public", using: :btree
  end

  create_table "services_users", id: false, force: :cascade do |t|
    t.integer "service_id", null: false
    t.integer "user_id",    null: false
    t.index ["user_id"], name: "index_services_users_on_user_id", using: :btree
  end

  create_table "ticket_granting_cookies", force: :cascade do |t|
